...
def draw(teams):
    ...
    for team in pool2:
        result = setTeamPosition(team['conf_name'], zoneA, zoneB, zoneC, zoneD, zoneE, zoneF, zoneG, zoneH, maxlength=2,teamsCount=countTeams(team['conf_name'],getTeamsMainDraw()))
        match (result):
            case 'A':
                zoneA.append(team)
            case 'B':
    ...
    for team in pool3:
        result = setTeamPosition(team['conf_name'], zoneA, zoneB, zoneC, zoneD, zoneE, zoneF, zoneG, zoneH, maxlength=3,teamsCount=countTeams(team['conf_name'],getTeamsMainDraw()))
        match (result):
            case 'A':
                zoneA.append(team)
            case 'B':
    ...
    for team in pool4:
        result = setTeamPosition(team['conf_name'], zoneA, zoneB, zoneC, zoneD, zoneE, zoneF, zoneG, zoneH, maxlength=4,teamsCount=countTeams(team['conf_name'],getTeamsMainDraw()))
        match (result):
            case 'A':
                zoneA.append(team)
            case 'B':
